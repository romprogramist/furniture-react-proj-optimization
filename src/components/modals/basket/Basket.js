  ...
  const items = [
    {
      ...
      price: 23,
      imgUrl:
        "https://the-flow.ru/uploads/images/resize/830x0/adaptiveResize/03/87/65/58/54/71075d640cd7.jpg",
    },
    {
      name: "tovar2",
      price: 28,
    ...
    <div className={`basket-window ${basketOpened ? "" : "none"}`}>
      ...
      <form>
        ...
        <div className="total-amount">
          <div>
            <p className="name">Сумма</p>
            <p className="price">9,999.99</p>
          </div>
          <button className="view-cart-button">Смотреть корзину</button>
        </div>
      </form>
    </div>
  );
